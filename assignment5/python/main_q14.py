...
wind_json_path = os.path.join(input_vars_path, "wind14.json")
...
print(f'Q14 Surge Std after TTrans [m]: {surge_std_post}')
print(f'Q14 Pitch Std after TTrans [deg]: {pitch_std_post}')